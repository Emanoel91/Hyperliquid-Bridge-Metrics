...
st.markdown(
    ...
    <div style="margin-top: 20px; margin-bottom: 20px; font-size: 16px;">
        <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 10px;">
            ...
            <span>Dashboard Reference: <a href="https://flipsidecrypto.xyz/pine/hyperliquid-bridge-metrics-lxNyGO" target="_blank">https://flipsidecrypto.xyz/pine/hyperliquid-bridge-metrics-lxNyGO/</a></span>
        </div>
        <div style="display: flex; align-items: center; gap: 10px;">
